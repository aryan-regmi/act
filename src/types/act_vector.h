...
/// @brief Shrinks the capacity to fit the length of the #act_vector_t.
///
...
/// @brief Get the allocator of the #act_vector_t.
///
...
/// @internal
/// @brief [PRIVATE] Gets a constant pointer to the #act_vector_t's header.
///
/// This is for internal use only; the #act_vector_header_t should never be
...
///
/// @sa #act_vector_header_t
const act_VectorHeader *act__vectorGetHeader(const act_Vector *vec,
                                             int *error_code);

/// @internal
/// @brief [PRIVATE] Gets a mutable pointer to the #act_vector_t's header.
///
/// This is for internal use only; the #act_vector_header_t should never be
/// accessed from public API.
///
...
/// @internal
/// @brief [PRIVATE] Increments the length of the #act_vector_t.
///
...
/// @internal
/// @brief [PRIVATE] Decrements the length of the #act_vector_t.
///
/// This is purely for macros that don't have access to the internals of the
/// #act_vector_header_t.
///
...
/// @internal
/// @brief [PRIVATE] Resizes the given #act_vector_t by doubling its capacity.
///
